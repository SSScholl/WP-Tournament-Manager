...
<body>
    <header class="b-hero">
        <div class="b-hero-wrap">
            <h1 id="headline">Tournament</h1>
            <p class="b-year"><i class="fa fa-star"></i> 2015 <i class="fa fa-star"></i></p>
    ...
    <section id="b">
        <div class="b-container">
            <div class="b-split b-split-one">
                <div class="b-round b-round-one b-current">
                    <div class="b-round-details">Round 1<br /><span class="date">March 16</span></div>
                    <ul class="b-matchup">
                ...
                <div class="b-round b-round-two">
                    <div class="b-round-details">Round 2<br /><span class="date">March 18</span></div>
                    <ul class="b-matchup">
                ...
                <div class="b-round b-round-three">
                    <div class="b-round-details">Round 3<br /><span class="date">March 22</span></div>
                    <ul class="b-matchup">
                        <li class="team team-top">&nbsp;<span class="score">&nbsp;</span></li>
                        <li class="team team-bottom">&nbsp;<span class="score">&nbsp;</span></li>
                    </ul>
            ...
            <div class="b-champion">
                <div class="b-semis-l">
                    <div class="b-round-details">west semifinals <br /><span class="date">March 26-28</span></div>
                    <ul class="b-matchup b-championship">
                ...
                <div class="b-final">
                    ...
                    <div class="b-round-details">championship <br /><span class="date">March 30 - Apr. 1</span></div>
                    <ul class="b-matchup b-championship">
                        <li class="team team-top">&nbsp;<span class="vote-count">&nbsp;</span></li>
                        <li class="team team-bottom">&nbsp;<span class="vote-count">&nbsp;</span></li>
                    </ul>
                ...
                <div class="b-semis-r">
                    <div class="b-round-details">east semifinals <br /><span class="date">March 26-28</span></div>
                    <ul class="b-matchup b-championship">
                        <li class="team team-top">&nbsp;<span class="vote-count">&nbsp;</span></li>
                        <li class="team team-bottom">&nbsp;<span class="vote-count">&nbsp;</span></li>
                    </ul>
