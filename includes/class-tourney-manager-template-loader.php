...
class Tourney_Template_Loader
{
	...
	public static function get_instance()
	{
		...
		if (null == self::$instance) {
			self::$instance = new Tourney_Template_Loader();
		}
	...
	public function view_project_template($template)
	{
		...
		$filepath = apply_filters('page_templater_plugin_dir_path', plugin_dir_path(__DIR__));

		$file = $filepath . 'public/templates/' . get_post_meta(
			$post->ID,
			'_wp_page_template',
			true
		);
